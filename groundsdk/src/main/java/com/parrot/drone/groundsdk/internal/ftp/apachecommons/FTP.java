...
public class FTP extends SocketClient
{
    ...
    private void __getReply(boolean reportReply) throws IOException
    {
        ...
        // hack for flying in sphinx
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 1\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 2\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 3\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 4\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 5\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 6\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 7\n", "");
        line = line.replace("I libshdata: Memory section \"sphinx-time\" successfully open with revision number : 8\n", "");
        line = line.replace("I ftpd: redirecting syslog to ulog\n", "");
